 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://WebServiceDemoService/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://WebServiceDemoService/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://WebServiceDemoService/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebServiceDemoService/", "HelloServicePort"), HelloService.class, features);
    }
